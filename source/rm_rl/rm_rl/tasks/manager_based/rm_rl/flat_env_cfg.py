...
class FlatEnvCfg(RoughEnvCfg):
    def __post_init__(self):
        ...
        # Rewards
        self.rewards.track_lin_vel_x_exp.weight = 25.0
        self.rewards.track_lin_vel_x_exp.params["std"] = 0.5
        ...
        # self.commands.base_velocity.ranges.lin_vel_y = (0., 0.)
        # self.commands.base_velocity.ranges.ang_vel_z = (-6.28, 6.28)
